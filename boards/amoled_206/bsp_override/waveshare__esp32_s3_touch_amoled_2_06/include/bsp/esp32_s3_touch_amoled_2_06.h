...
/* On-board interrupt and system signals */
#define BSP_PMU_SYS_OUT       (GPIO_NUM_10)
#define BSP_IMU_INT1          (GPIO_NUM_21)
#define BSP_RTC_INT           (GPIO_NUM_39)

/* uSD card */
#define BSP_SD_D0            (GPIO_NUM_3)
#define BSP_SD_CMD           (GPIO_NUM_1)
#define BSP_SD_CLK           (GPIO_NUM_2)
#define BSP_SD_DAT3          (GPIO_NUM_17)
